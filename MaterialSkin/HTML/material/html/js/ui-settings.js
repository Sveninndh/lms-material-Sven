...
`,
    data() {
        return {
            ...
            ndShortcuts: false,
            ndShortcutValues: [],
            userid: '',  //Sven 2026-02-05 
            userids: [], //Sven 2026-02-05
            detailedHomeValues:{},
            detailedHomeItems:[],
    ...
    methods: {
        readStore() {
            ...
            this.userid = this.$store.state.userid; //Sven 2026-02-05
        ...
        initItems() {
            ...
            this.userids = [{ key: '', label: i18n('None') }]; //#Sven 2026-02-10
                for (let i = 1; i <= 9; i++) {
        ...
        settings(arrays, withSorts) {
            let settings = {
                      ...
                      userid:this.userid, //Sven 2026-02-10
